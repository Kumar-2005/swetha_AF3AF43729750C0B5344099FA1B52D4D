''' Implement a class called BakAccount that represents a bank account. The class should have private
...
cannot the accessed directly from outside the class Write a program to create an instance of the
